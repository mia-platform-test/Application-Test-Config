...
This repository contains all the configuration resources required for the Application Test project to function properly and expose its business features.
